...
WiFiManagerExtClass is the reusable WiFi connection and captive-portal controller for this project.
...
`WifiSettings` is owned by [include/WiFiManagerExtClass.h](include/WiFiManagerExtClass.h) as `WiFiManagerExtClass::WifiSettings`.
